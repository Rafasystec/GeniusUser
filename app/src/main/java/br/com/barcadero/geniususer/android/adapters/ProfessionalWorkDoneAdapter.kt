 ...
 */
class ProfessionalWorkDoneAdapter(
        val agendas: List<ClientAgendaResponse>,
        val onClick: (ClientAgendaResponse) -> Unit) : RecyclerView.Adapter<ProfessionalWorkDoneAdapter.ProfessionalViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfessionalViewHolder{
        val view = LayoutInflater.from(parent.context).inflate(R.layout.adapter_professional_work_done,parent,false)
