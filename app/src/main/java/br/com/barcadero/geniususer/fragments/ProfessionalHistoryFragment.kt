...
import br.com.barcadero.geniususer.android.adapters.ProfessionalHistoryAdapter
 ...
 */
class ProfessionalHistoryFragment : BaseFragment() {
    ...
    private fun loadAdapter() {
        ...
        agendaClient.clientPhotoUrl="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSdL1s1tMcbRkQm2VhwJUVrKmFTAqm4FprzAtAMONpZVTkFjFPlA"
        ...
        agendaClient1.clientPhotoUrl="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDCtOFJuZ9gaLW9WLXGSYzoJM0a8H8ejYEqoIs9Rg7kKAPT26P"
        ...
        recycleView?.adapter = ProfessionalHistoryAdapter(listOf(agendaClient, agendaClient1), onClick = { startAgendaClientDetails(agendaClient) })
    }
